...
class ColourANOM:
    ...
    def predict(self, img_rgb: tf.Tensor)->dict:
        ...
        colour_map = anomaly_map_to_color_map(anomaly_map.numpy())
        heatmap = superimpose_anomaly_map(anomaly_map.numpy(), img_rgb.numpy())
        mask = compute_mask(anomaly_map.numpy(), 20)
